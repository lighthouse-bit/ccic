...
import afforest1 from '../../Assests/afforest1.png'
import afforest2 from '../../Assests/afforest2.png'
import afforest3 from '../../Assests/afforest3.png'

const Afforestation = () => {
  return (
    <div className='afforestation-container'>
        <h2>AFFORESTATION PROJECT IN ZAMBIA</h2>
        <div className="afforestation-image">
