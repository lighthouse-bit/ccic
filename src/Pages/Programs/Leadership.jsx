...
import yl1 from '../../Components/Assests/yl1.png'
import yl2 from '../../Components/Assests/yl2.png'
import yl3 from '../../Components/Assests/yl3.png'

const Leadership = () => {
  return (
    <div className='leadership'>
        <h2>YOUTH LEADERSHIP IN CLIMATE ACTION AND PEACE BUILDING</h2>
