...
import './CSS/youthConsult.css'
import consult1 from '../../Components/Assests/consult1.png'
import consult2 from '../../Components/Assests/consult2.png'
import consult3 from '../../Components/Assests/consult3.png'

const YouthConsult = () => {
  return (
    <div className='youth'>
        <h2>YOUTH VIRTUAL CONSULTATIONS FOR SIERRA LEONE - NATIONAL YOUTH STATEMENT(NYS)</h2>
