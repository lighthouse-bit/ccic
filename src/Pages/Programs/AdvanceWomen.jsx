...
import './CSS/advanceWomen.css'
import adw from '../../Components/Assests/adw.png'
import adw1 from '../../Components/Assests/adw1.png'
import adw3 from '../../Components/Assests/adw3.png'

const AdvanceWomen = () => {
  return (
    <div className='advance'>
        <h2>ADVANCING WOMEN AND GIRLS IN CILAMTE RESILIENCE</h2>
