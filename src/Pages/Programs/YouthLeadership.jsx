...
import './CSS/youthLeader.css'
import leader1 from '../../Components/Assests/leader1.png'
import leader2 from '../../Components/Assests/leader2.png'
import leader3 from '../../Components/Assests/leader3.png'

const YouthLeadership = () => {
  return (
    <div className='youthleader'>
        <h2>LEADERSHIP AND EMPOWERMENT PROGRAM IN YORK VILLAGE</h2>
        <hr style={{marginBottom:"4rem"}}/>
        <div className="youthleader-img">
            <img src={leader1} alt="" />
            <img src={leader2} alt="" />
            <img src={leader3} alt="" />
        </div>
